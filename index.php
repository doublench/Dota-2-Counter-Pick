...
<html lang="en">
<head>
    <title>Dota 2 Counter Pick</title>
    <meta charset="UTF-8"/>
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description"
          content="Dota 2 Counter Picker && Meta Heroes Picker">
    <meta name="keywords"
          content="dota 2, counter, pick, meta, heroes">
    <meta name="author" content="Codrops && doublench">
...
<div class="container">
    <div class="header">
        <a href="#">
            <strong>&laquo; Previous Demo: </strong>Interactive Typography Effects
				...
				<span class="right">
                    <a href="#" target="_blank">Images by Geoff Peters</a>
                        <a href="#">
    ...
    <div id="bx-wrapper" class="bx-wrapper">
        ...
        <div class="bx-content">
            <h2>Autoplay тут инпут</h2>
        </div>
        <div class="bx-container">
            <?php
            for ($i = 1; $i <= 10; $i++) {
                echo '<img src="images/large/dota/__' . rand(1, 140) . '.jpg">';
            }
            ?>
        </div>
